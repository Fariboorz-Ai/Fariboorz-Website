      ...
      <main className="flex-1 p-8 space-y-8 max-w-7xl ml-64">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-3 py-2 bg-red-500/10 rounded-lg border border-red-500/20">
                <Icon icon="mdi:bell" className="w-4 h-4 text-red-500" />
                <span className="text-sm text-white">{data.stats.unread} unread</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <button className="px-4 py-2 rounded-lg text-sm font-medium transition-all bg-red-600 text-white">
              All ({data.stats.total})
            </button>
            <button className="px-4 py-2 rounded-lg text-sm font-medium transition-all bg-gray-800/50 text-gray-400 hover:bg-gray-700/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="bg-gradient-to-br from-red-900/50 to-red-800/30 backdrop-blur border border-red-700/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-red-300">Unread</p>
          ...
          <Card className="bg-gradient-to-br from-green-900/50 to-green-800/30 backdrop-blur border border-green-700/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-green-300">Read</p>
                  <p className="text-2xl font-bold text-white">{data.stats.read}</p>
                </div>
          ...
          <Card className="bg-gradient-to-br from-purple-900/50 to-purple-800/30 backdrop-blur border border-purple-700/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-purple-300">Trade Alerts</p>
                  <p className="text-2xl font-bold text-white">{data.stats.typeCounts.trade}</p>
                </div>
